...
var A11yModule = /* @__PURE__ */ (() => {
  const _A11yModule = class _A11yModule {
...
var DialogModule = /* @__PURE__ */ (() => {
  ...
  let DialogModule2 = _DialogModule;
...
var MatDialogModule = /* @__PURE__ */ (() => {
  ...
  let MatDialogModule2 = _MatDialogModule;
  return MatDialogModule2;
})();

// src/app/services/commmande/commande.service.ts
var CommandeService = /* @__PURE__ */ (() => {
  const _CommandeService = class _CommandeService {
    constructor(httpClient) {
      this.httpClient = httpClient;
      this.API_URL = "http://localhost:8080/api/commandes/";
      this.ENDPOINT_CREATE = "create";
      this.ENDPOINT_UPDATE = "update/";
      this.ENDPOINT_DELETE = "delete/";
      this.ENDPOINT_DESACTIVATE = "desactivate/";
    ...
    create(commande) {
      return this.httpClient.post(this.API_URL + this.ENDPOINT_CREATE, commande, this.httpOptions).pipe(tap((data) => console.log("data: ", data)), catchError(this.handleError));
    }
    update(id, commande) {
      return this.httpClient.put(this.API_URL + this.ENDPOINT_UPDATE + id, commande).pipe(tap((data) => console.log("data: ", data)), catchError(this.handleError));
    }
    delete(id) {
      return this.httpClient.delete(this.API_URL + this.ENDPOINT_DELETE + id).pipe(tap((data) => console.log("data: ", data)), catchError(this.handleError));
    }
    desactivate(id) {
      return this.httpClient.delete(this.API_URL + this.ENDPOINT_DESACTIVATE + id).pipe(tap((data) => console.log("data: ", data)), catchError(this.handleError));
    }
    getAll() {
      return this.httpClient.get(this.API_URL + this.ENDPOINT_READ + "all").pipe(tap((data) => console.log("data: ", data)), catchError(this.handleError));
    }
    getById(id) {
      return this.httpClient.get(this.API_URL + this.ENDPOINT_READ + "id/" + id).pipe(tap((data) => console.log("data: ", data)), catchError(this.handleError));
    }
    handleError(error) {
  ...
  _CommandeService.\u0275fac = function CommandeService_Factory(t) {
    return new (t || _CommandeService)(\u0275\u0275inject(HttpClient));
  };
  _CommandeService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
    token: _CommandeService,
    factory: _CommandeService.\u0275fac,
    providedIn: "root"
  });
  let CommandeService2 = _CommandeService;
  return CommandeService2;
})();
...
@angular/platform-browser/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-QM6LZK6Q.js.map
