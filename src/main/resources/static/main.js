...
var routes = [{
  ...
  path: "store",
  loadComponent: () => import("./chunk-CIMQJO7Z.js").then((m) => m.StoreComponent)
}, {
  path: "calc",
  loadComponent: () => import("./chunk-ILQANSSO.js").then((m) => m.CalcComponent)
}];

// src/app/shared/globals-variables.ts
var GlobalsVariables = /* @__PURE__ */ (() => {
  const _GlobalsVariables = class _GlobalsVariables {
    constructor() {
      this.isLoading = false;
    }
  };
  _GlobalsVariables.\u0275fac = function GlobalsVariables_Factory(t) {
    return new (t || _GlobalsVariables)();
  };
  _GlobalsVariables.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
    token: _GlobalsVariables,
    factory: _GlobalsVariables.\u0275fac,
    providedIn: "root"
  });
  let GlobalsVariables2 = _GlobalsVariables;
  return GlobalsVariables2;
})();

// src/app/app.config.ts
var appConfig = {
  providers: [provideRouter(routes), provideClientHydration(), provideHttpClient(withFetch()), importProvidersFrom(HttpClientModule), importProvidersFrom(GlobalsVariables)]
};
...
var AppComponent = /* @__PURE__ */ (() => {
  ...
  _AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    decls: 14,
    vars: 9,
    consts: [[1, "card", 2, "background-color", "#ff000000", "height", "100vh", "width", "100%"], [1, "card-header", "text-center", 2, "background-color", "#938585"], [1, "nav", "nav-tabs", "card-header-tabs"], [1, "nav-item"], [1, "nav-link", "brand", 2, "font-style", "normal", "color", "black"], ["routerLinkActive", "active", 1, "nav-link", 3, "routerLink", "routerLinkActiveOptions"], [1, "card-body", 2, "background-color", "#9385854f", "width", "100%"]],
    template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "ul", 2)(3, "li", 3)(4, "a", 4);
        \u0275\u0275text(5);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(6, "li", 3)(7, "a", 5);
        \u0275\u0275text(8, "Calc");
        \u0275\u0275elementEnd()();
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(5, _c0))("routerLinkActiveOptions", \u0275\u0275pureFunction0(6, _c1));
        \u0275\u0275advance(3);
        \u0275\u0275property("routerLink", \u0275\u0275pureFunction0(7, _c2))("routerLinkActiveOptions", \u0275\u0275pureFunction0(8, _c1));
      }
    },
    dependencies: [CommonModule, RouterOutlet, RouterLink, RouterLinkActive],
    styles: ["\n\n.brand[_ngcontent-%COMP%]:hover {\n  border: none;\n}\n/*# sourceMappingURL=data:application/json;base64,ewogICJ2ZXJzaW9uIjogMywKICAic291cmNlcyI6IFsic3JjL2FwcC9hcHAuY29tcG9uZW50LnNjc3MiXSwKICAic291cmNlc0NvbnRlbnQiOiBbIi5icmFuZDpob3ZlciB7XG4gICAgYm9yZGVyOiBub25lO1xufVxuIl0sCiAgIm1hcHBpbmdzIjogIjtBQUFBLENBQUEsS0FBQTtBQUNJLFVBQUE7OyIsCiAgIm5hbWVzIjogW10KfQo= */"]
  });
